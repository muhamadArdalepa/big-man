            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="nama" id="nama" class="form-control" placeholder="Nama Teknisi" autofocus
                            tabindex="1">
                        <div id="namaFeedback" class="invalid-feedback text-xs"></div>
                    </div>

                    <div class="form-group">
                        <label for="speciality" class="form-control-label">Keahlian</label>
                        <input type="speciality" id="speciality" class="form-control" placeholder="Keahlian" autofocus
                            tabindex="2">
                        <div id="specialityFeedback" class="invalid-feedback text-xs"></div>
                    </div>
...
@push('js')
    <script>
        ...
        const baseUrl = appUrl + '/api/teknisi'
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type) {
                        if (type === 'display') {
                            return `
                        <a href="${appUrl}/teknisi/${data}" class="btn btn-link text-secondary font-weight-normal">
                            Detail
                        </a>
                        `
                        }
