        ...
        <div class="card-header pb-0">
            <div class="d-flex gap-3">
                <div class="d-flex align-items-center">
                    <label for="wilayah" class="m-0 d-none d-sm-inline-block">Kota</label>
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" class="form-control" placeholder="Nama Pelanggan" autofocus
                                tabindex="1">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" id="detailPaket" class="form-control" placeholder="Serial Number"
                                    tabindex="2" disabled>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="detailKet" class="form-control" rows="2" placeholder="Detail Gangguan"
                                tabindex="4" disabled></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="detailAlamat" class="form-control" rows="2" placeholder="Detail Gangguan"
                                tabindex="5" disabled></textarea>
                    ...
                    <div class="col-6 col-md-2">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="number " id="detailPoin" class="form-control" placeholder="Poin Pekerjaan"
                                    autofocus tabindex="9">
            ...
            $('.btn-detail-laporan').on('click', (e) => {
                ...
                fetch(`${baseUrl}/${e.target.dataset.laporan}`)
                    ...
                    .then(data => {
                        ...
                        $('#ModalImg').attr('src', appUrl + '/storage/private/profile/' + data.foto_profil)
