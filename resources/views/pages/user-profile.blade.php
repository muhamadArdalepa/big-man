        ...
        <div class="row gx-4">
            <div class="col-auto">
                <div class="avatar avatar-xl position-relative">
                    <img src="{{route('storage.private','profile/'.$user->foto_profil)}}" alt="profile_image"
                    ...
                    <div class="accordion accordion-flush" id="timAccordion">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-heading{{$i}}">
                                <button class="accordion-button collapsed text-xs fw-bold" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="flush-collapse{{$i}}" class="accordion-collapse collapse"
                                aria-labelledby="flush-heading{{$i}}" data-bs-parent="#timAccordion">
